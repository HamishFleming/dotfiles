...
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    --set_wallpaper(s) --Default wallpaper setter for awesome; this caused issues with nitrogen restore so  i have commented the function out for now
...
globalkeys = gears.table.join(
    ...
    -- Power Options
    awful.key({modkey, "Control"}, "p", function () awful.util.spawn("shutdown_dmenu.sh") end,
	{description = "Dmenu Power Bar", group = "system"}),
    ...
    awful.key({ modkey },	"e",	function()
	    awful.util.spawn("terminator -x ranger")end,
	    {description = "open ranger in ~/", group="launcher"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,    }, "q",      function (c) c:kill()                         end,
              {description = "close focus client", group = "client"}),
