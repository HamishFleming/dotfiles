...
git add .
#Initial commit message, might make it a passable var
git commit -a -m "Initial Commit"
#must run this group, microsoft went too hard on ending racism and renaming master
git branch -M main
...
#Push everything allrealy in the folder, will probably make this a flag
